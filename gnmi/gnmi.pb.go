...
func (SubscriptionList_Mode) EnumDescriptor() ([]byte, []int) {
	return file_gnmi_proto_rawDescGZIP(), []int{14, 0}
}
...
func (UpdateResult_Operation) EnumDescriptor() ([]byte, []int) {
	return file_gnmi_proto_rawDescGZIP(), []int{21, 0}
}
...
func (GetRequest_DataType) EnumDescriptor() ([]byte, []int) {
	return file_gnmi_proto_rawDescGZIP(), []int{22, 0}
}
...
type Update struct {
	...
	FrameNumber uint32      `protobuf:"varint,5,opt,name=frame_number,json=frameNumber,proto3" json:"frame_number,omitempty"` // Used to track the Update messages
}
...
func (x *Update) GetFrameNumber() uint32 {
	if x != nil {
...
type TypedValue struct {
	...
	//	*TypedValue_AsciiVal
	//	*TypedValue_ComplexVal
	//	*TypedValue_Complex64Val
...
func (x *TypedValue) GetComplexVal() *ComplexType {
	if x, ok := x.GetValue().(*TypedValue_ComplexVal); ok {
		return x.ComplexVal
	}
	return nil
}

func (x *TypedValue) GetComplex64Val() *Complex64Type {
	if x, ok := x.GetValue().(*TypedValue_Complex64Val); ok {
		return x.Complex64Val
	}
	return nil
}
...
type TypedValue_ComplexVal struct {
	ComplexVal *ComplexType `protobuf:"bytes,13,opt,name=complex_val,json=complexVal,proto3,oneof"` // Complex float type value
}

type TypedValue_Complex64Val struct {
	Complex64Val *Complex64Type `protobuf:"bytes,14,opt,name=complex64_val,json=complex64Val,proto3,oneof"` // Complex with precision upto 19 digits value
}
...
func (*TypedValue_ComplexVal) isTypedValue_Value() {}

func (*TypedValue_Complex64Val) isTypedValue_Value() {}
...
// ComplexType is used to encode complex number in Update message
type ComplexType struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Real float32 `protobuf:"fixed32,1,opt,name=real,proto3" json:"real,omitempty"` // real part
	Imag float32 `protobuf:"fixed32,2,opt,name=imag,proto3" json:"imag,omitempty"` // imaginary part
}
...
func (x *ComplexType) GetReal() float32 {
	if x != nil {
		return x.Real
	}
	return 0
...
func (x *ComplexType) GetImag() float32 {
	if x != nil {
		return x.Imag
	}
	return 0
...
// Complex64Type is used to encode complex64 bit number in Update message
type Complex64Type struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	//Decimal64 will give precision upto 19digit after decimal.
	//What is rationale behind using Decimal64?
	Real *Decimal64 `protobuf:"bytes,1,opt,name=real,proto3" json:"real,omitempty"` // real part,
	Imag *Decimal64 `protobuf:"bytes,2,opt,name=imag,proto3" json:"imag,omitempty"` // imaginary part
}

func (x *Complex64Type) Reset() {
	*x = Complex64Type{}
	if protoimpl.UnsafeEnabled {
...
func (x *Complex64Type) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Complex64Type) ProtoMessage() {}

func (x *Complex64Type) ProtoReflect() protoreflect.Message {
	mi := &file_gnmi_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Complex64Type.ProtoReflect.Descriptor instead.
func (*Complex64Type) Descriptor() ([]byte, []int) {
	return file_gnmi_proto_rawDescGZIP(), []int{9}
}

func (x *Complex64Type) GetReal() *Decimal64 {
	if x != nil {
		return x.Real
	}
	return nil
...
func (x *Complex64Type) GetImag() *Decimal64 {
	if x != nil {
		return x.Imag
	}
	return nil
...
type Subscription struct {
	...
	SampleInterval uint64           `protobuf:"varint,3,opt,name=sample_interval,json=sampleInterval,proto3" json:"sample_interval,omitempty"` // ns between sample in SAMPLE mode.
...
func (x *CapabilityResponse) Reset() {
	*x = CapabilityResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gnmi_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CapabilityResponse) Descriptor() ([]byte, []int) {
	return file_gnmi_proto_rawDescGZIP(), []int{25}
}
...
func (x *ModelData) Reset() {
	*x = ModelData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gnmi_proto_msgTypes[26]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ModelData) Descriptor() ([]byte, []int) {
	return file_gnmi_proto_rawDescGZIP(), []int{26}
}
...
var file_gnmi_proto_rawDesc = []byte{
	...
	0xb0, 0x01, 0x0a, 0x0c, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x67, 0x6e, 0x6d, 0x69, 0x2e, 0x44, 0x65, 0x63, 0x69, 0x6d,
	...
	0x61, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x67, 0x6e, 0x6d, 0x69, 0x2e,
	...
	,
	...
	0x18, 0x01, 0x22, 0x41, 0x0a, 0x09, 0x44, 0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c, 0x36, 0x34, 0x12,
	...
	,
	...
	0x6e, 0x42, 0x09, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x06, 0x0a, 0x04,
	0x50, 0x6f, 0x6c, 0x6c, 0x22, 0xd0, 0x01, 0x0a, 0x11, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69,
	0x62, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x06, 0x75, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67, 0x6e, 0x6d,
	0x69, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x12, 0x31, 0x0a, 0x09, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x18,
	...
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x67, 0x6e, 0x6d, 0x69, 0x5f, 0x65, 0x78, 0x74,
	0x2e, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x09, 0x65, 0x78, 0x74, 0x65,
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xe8, 0x01, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	,
	...
	,
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x25, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x67, 0x6e, 0x6d, 0x69, 0x2e, 0x45, 0x72, 0x72,
	0x6f, 0x72, 0x42, 0x02, 0x18, 0x01, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x31, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x30, 0x01, 0x3a, 0x40, 0x0a, 0x0c, 0x67, 0x6e, 0x6d, 0x69, 0x5f, 0x73, 0x65, 0x72, 0x76,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x42, 0x08, 0xca, 0x3e, 0x05, 0x30, 0x2e, 0x36, 0x2e, 0x30, 0x62,
...
var file_gnmi_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_gnmi_proto_goTypes = []interface{}{
	...
	(*ComplexType)(nil),            // 13: gnmi.ComplexType
	(*Complex64Type)(nil),          // 14: gnmi.Complex64Type
	(*ScalarArray)(nil),            // 15: gnmi.ScalarArray
	(*SubscribeRequest)(nil),       // 16: gnmi.SubscribeRequest
	(*Poll)(nil),                   // 17: gnmi.Poll
	(*SubscribeResponse)(nil),      // 18: gnmi.SubscribeResponse
	(*SubscriptionList)(nil),       // 19: gnmi.SubscriptionList
	(*Subscription)(nil),           // 20: gnmi.Subscription
	(*QOSMarking)(nil),             // 21: gnmi.QOSMarking
	(*Alias)(nil),                  // 22: gnmi.Alias
	(*AliasList)(nil),              // 23: gnmi.AliasList
	(*SetRequest)(nil),             // 24: gnmi.SetRequest
	(*SetResponse)(nil),            // 25: gnmi.SetResponse
	(*UpdateResult)(nil),           // 26: gnmi.UpdateResult
	(*GetRequest)(nil),             // 27: gnmi.GetRequest
	(*GetResponse)(nil),            // 28: gnmi.GetResponse
	(*CapabilityRequest)(nil),      // 29: gnmi.CapabilityRequest
	(*CapabilityResponse)(nil),     // 30: gnmi.CapabilityResponse
	(*ModelData)(nil),              // 31: gnmi.ModelData
	nil,                            // 32: gnmi.PathElem.KeyEntry
	(*any.Any)(nil),                // 33: google.protobuf.Any
	(*gnmi_ext.Extension)(nil),     // 34: gnmi_ext.Extension
	(*descriptor.FileOptions)(nil), // 35: google.protobuf.FileOptions
}
var file_gnmi_proto_depIdxs = []int32{
	...
	15, // 7: gnmi.TypedValue.leaflist_val:type_name -> gnmi.ScalarArray
	33, // 8: gnmi.TypedValue.any_val:type_name -> google.protobuf.Any
	13, // 9: gnmi.TypedValue.complex_val:type_name -> gnmi.ComplexType
	14, // 10: gnmi.TypedValue.complex64_val:type_name -> gnmi.Complex64Type
	9,  // 11: gnmi.Path.elem:type_name -> gnmi.PathElem
	32, // 12: gnmi.PathElem.key:type_name -> gnmi.PathElem.KeyEntry
	0,  // 13: gnmi.Value.type:type_name -> gnmi.Encoding
	33, // 14: gnmi.Error.data:type_name -> google.protobuf.Any
	12, // 15: gnmi.Complex64Type.real:type_name -> gnmi.Decimal64
	12, // 16: gnmi.Complex64Type.imag:type_name -> gnmi.Decimal64
	7,  // 17: gnmi.ScalarArray.element:type_name -> gnmi.TypedValue
	19, // 18: gnmi.SubscribeRequest.subscribe:type_name -> gnmi.SubscriptionList
	17, // 19: gnmi.SubscribeRequest.poll:type_name -> gnmi.Poll
	23, // 20: gnmi.SubscribeRequest.aliases:type_name -> gnmi.AliasList
	34, // 21: gnmi.SubscribeRequest.extension:type_name -> gnmi_ext.Extension
	5,  // 22: gnmi.SubscribeResponse.update:type_name -> gnmi.Notification
	11, // 23: gnmi.SubscribeResponse.error:type_name -> gnmi.Error
	34, // 24: gnmi.SubscribeResponse.extension:type_name -> gnmi_ext.Extension
	8,  // 25: gnmi.SubscriptionList.prefix:type_name -> gnmi.Path
	20, // 26: gnmi.SubscriptionList.subscription:type_name -> gnmi.Subscription
	21, // 27: gnmi.SubscriptionList.qos:type_name -> gnmi.QOSMarking
	2,  // 28: gnmi.SubscriptionList.mode:type_name -> gnmi.SubscriptionList.Mode
	31, // 29: gnmi.SubscriptionList.use_models:type_name -> gnmi.ModelData
	0,  // 30: gnmi.SubscriptionList.encoding:type_name -> gnmi.Encoding
	8,  // 31: gnmi.Subscription.path:type_name -> gnmi.Path
	1,  // 32: gnmi.Subscription.mode:type_name -> gnmi.SubscriptionMode
	8,  // 33: gnmi.Alias.path:type_name -> gnmi.Path
	22, // 34: gnmi.AliasList.alias:type_name -> gnmi.Alias
	8,  // 35: gnmi.SetRequest.prefix:type_name -> gnmi.Path
	8,  // 36: gnmi.SetRequest.delete:type_name -> gnmi.Path
	6,  // 37: gnmi.SetRequest.replace:type_name -> gnmi.Update
	6,  // 38: gnmi.SetRequest.update:type_name -> gnmi.Update
	34, // 39: gnmi.SetRequest.extension:type_name -> gnmi_ext.Extension
	8,  // 40: gnmi.SetResponse.prefix:type_name -> gnmi.Path
	26, // 41: gnmi.SetResponse.response:type_name -> gnmi.UpdateResult
	11, // 42: gnmi.SetResponse.message:type_name -> gnmi.Error
	34, // 43: gnmi.SetResponse.extension:type_name -> gnmi_ext.Extension
	8,  // 44: gnmi.UpdateResult.path:type_name -> gnmi.Path
	11, // 45: gnmi.UpdateResult.message:type_name -> gnmi.Error
	3,  // 46: gnmi.UpdateResult.op:type_name -> gnmi.UpdateResult.Operation
	8,  // 47: gnmi.GetRequest.prefix:type_name -> gnmi.Path
	8,  // 48: gnmi.GetRequest.path:type_name -> gnmi.Path
	4,  // 49: gnmi.GetRequest.type:type_name -> gnmi.GetRequest.DataType
	0,  // 50: gnmi.GetRequest.encoding:type_name -> gnmi.Encoding
	31, // 51: gnmi.GetRequest.use_models:type_name -> gnmi.ModelData
	34, // 52: gnmi.GetRequest.extension:type_name -> gnmi_ext.Extension
	5,  // 53: gnmi.GetResponse.notification:type_name -> gnmi.Notification
	11, // 54: gnmi.GetResponse.error:type_name -> gnmi.Error
	34, // 55: gnmi.GetResponse.extension:type_name -> gnmi_ext.Extension
	34, // 56: gnmi.CapabilityRequest.extension:type_name -> gnmi_ext.Extension
	31, // 57: gnmi.CapabilityResponse.supported_models:type_name -> gnmi.ModelData
	0,  // 58: gnmi.CapabilityResponse.supported_encodings:type_name -> gnmi.Encoding
	34, // 59: gnmi.CapabilityResponse.extension:type_name -> gnmi_ext.Extension
	35, // 60: gnmi.gnmi_service:extendee -> google.protobuf.FileOptions
	29, // 61: gnmi.gNMI.Capabilities:input_type -> gnmi.CapabilityRequest
	27, // 62: gnmi.gNMI.Get:input_type -> gnmi.GetRequest
	24, // 63: gnmi.gNMI.Set:input_type -> gnmi.SetRequest
	16, // 64: gnmi.gNMI.Subscribe:input_type -> gnmi.SubscribeRequest
	16, // 65: gnmi.gNMI.SubscribeWeb:input_type -> gnmi.SubscribeRequest
	30, // 66: gnmi.gNMI.Capabilities:output_type -> gnmi.CapabilityResponse
	28, // 67: gnmi.gNMI.Get:output_type -> gnmi.GetResponse
	25, // 68: gnmi.gNMI.Set:output_type -> gnmi.SetResponse
	18, // 69: gnmi.gNMI.Subscribe:output_type -> gnmi.SubscribeResponse
	18, // 70: gnmi.gNMI.SubscribeWeb:output_type -> gnmi.SubscribeResponse
	66, // [66:71] is the sub-list for method output_type
	61, // [61:66] is the sub-list for method input_type
	61, // [61:61] is the sub-list for extension type_name
	60, // [60:61] is the sub-list for extension extendee
...
func file_gnmi_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gnmi_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gnmi_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
	...
	file_gnmi_proto_msgTypes[2].OneofWrappers = []interface{}{
		...
		(*TypedValue_ComplexVal)(nil),
		(*TypedValue_Complex64Val)(nil),
	}
	...
	file_gnmi_proto_msgTypes[13].OneofWrappers = []interface{}{
...
type GNMIClient interface {
	...
	// SubscribeWeb allows a client to request the target to send it values
	// of particular paths within the data tree.
	// This is a one-directional api unlike gNMI::Subscribe() which is bidi.
	// This has been added as a stop-gap solution to be used with grpc-web
	// which does not support bidi streaming, as of May 2018.
	SubscribeWeb(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (GNMI_SubscribeWebClient, error)
}
...
func (c *gNMIClient) SubscribeWeb(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (GNMI_SubscribeWebClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GNMI_serviceDesc.Streams[1], "/gnmi.gNMI/SubscribeWeb", opts...)
	if err != nil {
		return nil, err
	}
	x := &gNMISubscribeWebClient{stream}
...
type GNMI_SubscribeWebClient interface {
	Recv() (*SubscribeResponse, error)
	grpc.ClientStream
}

type gNMISubscribeWebClient struct {
	grpc.ClientStream
}

func (x *gNMISubscribeWebClient) Recv() (*SubscribeResponse, error) {
	m := new(SubscribeResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GNMIServer interface {
	...
	// This has been added as a stop-gap solution to be used with grpc-web
	// which does not support bidi streaming, as of May 2018.
	SubscribeWeb(*SubscribeRequest, GNMI_SubscribeWebServer) error
}
...
func (*UnimplementedGNMIServer) SubscribeWeb(*SubscribeRequest, GNMI_SubscribeWebServer) error {
...
func _GNMI_SubscribeWeb_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SubscribeRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GNMIServer).SubscribeWeb(m, &gNMISubscribeWebServer{stream})
}

type GNMI_SubscribeWebServer interface {
	Send(*SubscribeResponse) error
	grpc.ServerStream
}

type gNMISubscribeWebServer struct {
	grpc.ServerStream
}

func (x *gNMISubscribeWebServer) Send(m *SubscribeResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _GNMI_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SubscribeWeb",
			Handler:       _GNMI_SubscribeWeb_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "gnmi.proto",
